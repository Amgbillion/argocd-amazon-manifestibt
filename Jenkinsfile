node {
    ...
    env.IMAGE = 'annemariegainsom/amazon1'

    stage('Clone repository') {
             git branch: 'main', url: 'https://github.com/Amgbillion/argocd-amazon-manifestibt.git'  
    }
            ...
            script {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    withCredentials([usernamePassword(credentialsId: 'karo-github', passwordVariable: 'GIT_PASSWORD', usernameVariable: 'GIT_USERNAME')]) {
                        ...
                        sh "git config user.name annemariegainsom@gmail.com"
